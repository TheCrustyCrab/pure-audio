...
use pure_audio_clap::{clap_sys::{entry::clap_plugin_entry, version::CLAP_VERSION}, entry::Entry, factory::Factory};

static ENTRY: Entry = Entry::new(&Factory::new(c"pureaudio.Test", c"PureAudioOscillator", true, oscillator::process) as *const _ as *const c_void);
